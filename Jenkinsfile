...
//		 secret_map = httpRequest contentType: 'APPLICATION_JSON', customHeaders: [[maskValue: false, name: 'X-Vault-Token', value: 'abc123']], httpMode: 'POST', ignoreSslErrors: true, responseHandle: 'NONE', url: "http://34.69.161.191/v1/auth/${gitorg.input}/${appname.input}/role/${dc.input}/secret-id", wrapAsMultipart: false
